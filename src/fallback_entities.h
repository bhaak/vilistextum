...
/* Dashes */
{0x2010, "HYPHEN", STRING("-"), NULL},
{0x2011, "NON-BREAKING HYPHEN", STRING("-"), NULL},
{0x2012, "FIGURE DASH", STRING("-"), NULL},
{0x2013, "EN DASH", STRING("-"), NULL},
{0x2014, "EM DASH", STRING("--"), NULL},
{0x2015, "HORIZONTAL BAR", STRING("--"), NULL},

/* General punctation */
{0x2018, "LEFT SINGLE QUOTATION MARK",            STRING("'"), NULL},
{0x2019, "RIGHT SINGLE QUOTATION MARK",           STRING("'"), NULL},
{0x201A, "SINGLE LOW-9 QUOTATION MARK",           STRING("'"), NULL},
{0x201B, "SINGLE HIGH-REVERSED-9 QUOTATION MARK", STRING("'"), NULL},
{0x201C, "LEFT DOUBLE QUOTATION MARK",            STRING("\""), NULL},
{0x201D, "RIGHT DOUBLE QUOTATION MARK",           STRING("\""), NULL},
{0x201E, "DOUBLE LOW-9 QUOTATION MARK",           STRING("\""), NULL},
{0x201F, "DOUBLE HIGH-REVERSED-9 QUOTATION MARK", STRING("\""), NULL},
{0x2024, "ONE DOT LEADER", STRING("."), NULL},
{0x2025, "TWO DOT LEADER", STRING(".."), NULL},
{0x2026, "HORIZONTAL ELLIPSIS", STRING("..."), NULL},

{0x2032, "PRIME", STRING("'"), NULL},
{0x2033, "DOUBLE PRIME", STRING("''"), NULL},
{0x2034, "TRIPLE PRIME", STRING("'''"), NULL},
{0x2035, "REVERSED PRIME", STRING("`"), NULL},
{0x2036, "REVERSED DOUBLE PRIME", STRING("``"), NULL},
{0x2037, "REVERSED TRIPLE PRIME", STRING("```"), NULL},
{0x2038, "CARET", STRING("^"), NULL},
{0x2039, "SINGLE LEFT-POINTING ANGLE QUOTATION MARK",  STRING("<"), NULL},
{0x203A, "SINGLE RIGHT-POINTING ANGLE QUOTATION MARK", STRING(">"), NULL},

{0x2044, "FRACTION SLASH", STRING("/"), NULL},

/* @@      2150    Number Forms    218F */
/* @               Fractions */
{0x2150, "VULGAR FRACTION ONE SEVENTH", STRING("1/7"),  NULL},
{0x2151, "VULGAR FRACTION ONE NINTH",   STRING("1/9"),  NULL},
{0x2152, "VULGAR FRACTION ONE TENTH",   STRING("1/10"), NULL},

{0x2153, "VULGAR FRACTION ONE THIRD",     STRING("1/3"), NULL},
{0x2154, "VULGAR FRACTION TWO THIRDS",    STRING("2/3"), NULL},
{0x2155, "VULGAR FRACTION ONE FIFTH",     STRING("1/5"), NULL},
{0x2156, "VULGAR FRACTION TWO FIFTHS",    STRING("2/5"), NULL},
{0x2157, "VULGAR FRACTION THREE FIFTHS",  STRING("3/5"), NULL},
{0x2158, "VULGAR FRACTION FOUR FIFTHS",   STRING("4/5"), NULL},
{0x2159, "VULGAR FRACTION ONE SIXTH",     STRING("1/6"), NULL},
{0x215A, "VULGAR FRACTION FIVE SIXTHS",   STRING("5/6"), NULL},
{0x215B, "VULGAR FRACTION ONE EIGHTH",    STRING("1/8"), NULL},
{0x215C, "VULGAR FRACTION THREE EIGHTHS", STRING("3/8"), NULL},
{0x215D, "VULGAR FRACTION FIVE EIGHTHS",  STRING("5/8"), NULL},
{0x215E, "VULGAR FRACTION SEVEN EIGHTHS", STRING("7/8"), NULL},

{0x215F, "FRACTION NUMERATOR ONE",        STRING("1/"), NULL},
{0x2189, "VULGAR FRACTION ZERO THIRDS",   STRING("0/3"), NULL},

{0x2CFD, "COPTIC FRACTION ONE HALF",      STRING("1/2"), NULL},

{0x0D73, "MALAYALAM FRACTION ONE QUARTER",    STRING("1/4"), NULL},
{0x0D74, "MALAYALAM FRACTION ONE HALF",       STRING("1/2"), NULL},
{0x0D75, "MALAYALAM FRACTION THREE QUARTERS", STRING("3/4"), NULL},

{0xA830, "NORTH INDIC FRACTION ONE QUARTER",      STRING("1/4"),  NULL},
{0xA831, "NORTH INDIC FRACTION ONE HALF",         STRING("1/2"),  NULL},
{0xA832, "NORTH INDIC FRACTION THREE QUARTERS",   STRING("3/4"),  NULL},
{0xA833, "NORTH INDIC FRACTION ONE SIXTEENTH",    STRING("1/16"), NULL},
{0xA834, "NORTH INDIC FRACTION ONE EIGHTH",       STRING("1/8"),  NULL},
{0xA835, "NORTH INDIC FRACTION THREE SIXTEENTHS", STRING("3/16"), NULL},

{0x10E7B, "RUMI FRACTION ONE HALF",    STRING("1/2"), NULL},
{0x10E7C, "RUMI FRACTION ONE QUARTER", STRING("1/4"), NULL},
{0x10E7D, "RUMI FRACTION ONE THIRD",   STRING("1/3"), NULL},
{0x10E7E, "RUMI FRACTION TWO THIRDS",  STRING("2/3"), NULL},


/* Roman numerals */
{0x2160, "ROMAN NUMERAL ONE",                STRING("I"),    NULL},
{0x2161, "ROMAN NUMERAL TWO",                STRING("II"),   NULL},
{0x2162, "ROMAN NUMERAL THREE",              STRING("III"),  NULL},
{0x2163, "ROMAN NUMERAL FOUR",               STRING("IV"),   NULL},
{0x2164, "ROMAN NUMERAL FIVE",               STRING("V"),    NULL},
{0x2165, "ROMAN NUMERAL SIX",                STRING("VI"),   NULL},
{0x2166, "ROMAN NUMERAL SEVEN",              STRING("VII"),  NULL},
{0x2167, "ROMAN NUMERAL EIGHT",              STRING("VIII"), NULL},
{0x2168, "ROMAN NUMERAL NINE",               STRING("IX"),   NULL},
{0x2169, "ROMAN NUMERAL TEN",                STRING("X"),    NULL},
{0x216A, "ROMAN NUMERAL ELEVEN",             STRING("XI"),   NULL},
{0x216B, "ROMAN NUMERAL TWELVE",             STRING("XII"),  NULL},
{0x216C, "ROMAN NUMERAL FIFTY",              STRING("L"),    NULL},
{0x216D, "ROMAN NUMERAL ONE HUNDRED",        STRING("C"),    NULL},
{0x216E, "ROMAN NUMERAL FIVE HUNDRED",       STRING("D"),    NULL},
{0x216F, "ROMAN NUMERAL ONE THOUSAND",       STRING("M"),    NULL},
{0x2170, "SMALL ROMAN NUMERAL ONE",          STRING("i"),    NULL},
{0x2171, "SMALL ROMAN NUMERAL TWO",          STRING("ii"),   NULL},
{0x2172, "SMALL ROMAN NUMERAL THREE",        STRING("iii"),  NULL},
{0x2173, "SMALL ROMAN NUMERAL FOUR",         STRING("iv"),   NULL},
{0x2174, "SMALL ROMAN NUMERAL FIVE",         STRING("v"),    NULL},
{0x2175, "SMALL ROMAN NUMERAL SIX",          STRING("vi"),   NULL},
{0x2176, "SMALL ROMAN NUMERAL SEVEN",        STRING("vii"),  NULL},
{0x2177, "SMALL ROMAN NUMERAL EIGHT",        STRING("viii"), NULL},
{0x2178, "SMALL ROMAN NUMERAL NINE",         STRING("ix"),   NULL},
{0x2179, "SMALL ROMAN NUMERAL TEN",          STRING("x"),    NULL},
{0x217A, "SMALL ROMAN NUMERAL ELEVEN",       STRING("xi"),   NULL},
{0x217B, "SMALL ROMAN NUMERAL TWELVE",       STRING("xii"),  NULL},
{0x217C, "SMALL ROMAN NUMERAL FIFTY",        STRING("l"),    NULL},
{0x217D, "SMALL ROMAN NUMERAL ONE HUNDRED",  STRING("c"),    NULL},
{0x217E, "SMALL ROMAN NUMERAL FIVE HUNDRED", STRING("d"),    NULL},
{0x217F, "SMALL ROMAN NUMERAL ONE THOUSAND", STRING("m"),    NULL},

/* Addition for German typography */
{0x017F, "LATIN SMALL LETTER LONG S",    STRING("s"),  NULL},
{0x1E9E, "LATIN CAPITAL LETTER SHARP S", STRING("SS"), NULL},

/* misc */
{0x20AC, "EURO SIGN", STRING("EUR"), NULL},
